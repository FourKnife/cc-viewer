...
NEVER run `git commit`, `git push`, or `npm publish` without explicit user approval — always show the change summary first and wait for confirmation before each step.
